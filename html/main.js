$('document').ready(function() {
    ...
    function CreateNotificationDetailedrecklessdriver(data) {
        ...
        <div id="alert-info-detailedrecklessdriver"><i class="fas fa-palette"></i>' + data.info["color"] + '</div>\
        <div id="alert-info-detailedrecklessdriver"><i class="fas fa-car"></i>' + data.info["model"] + '</div>\
        <div id="alert-info-detailedrecklessdriver-plate"><i class="fas fa-closed-captioning"></i>' + data.info["plate"] + '</div>\
